...
const Forms = ({ noti }) => {
    ...
    return (
        <div className='w-full'>
            ...
            <form onSubmit={handleSubmit} className={`md:mt-10 mt-5 w-[100%] ${subscribed ? 'blur-md' : ''}`}>
                ...
                <motion.input
                    ...
                    className={` md:mt-10 mt-4 px-4 py-3 w-full text-black rounded-lg font-medium outline-none ${emailError ? 'focus:border-4 border-2 border-rose-600 text-rose-600 ' : 'bg-white'}`} />
                ...
                <div class='opposite-direction'>
                    <motion.button
                        ...
                        type='submit'
                        className='md:mt-10 mt-2 bg-black py-2 px-3 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-red-100'
                    >
                        Join newsletter
